...
class WeightRange {
 ...
 public:
  ...
  explicit WeightRange(const Weight& w1 , const Weight& w2);
  ...
  bool InRange(const Weight& w, bool inclusive = true);
  ...
  friend ostream& operator << (std::ostream& os, const WeightRange& w);
};
#endif
